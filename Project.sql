...
('Daniel', NULL, 'Smith', 1, 1, 'Professor teaching Biology and is open to lead a dialogue', 'smith@example.edu'),
('Weasley', 'Donald', 'Ron', 2, 1, 'Professor teaching Chemistry and is closed to leading a dialogue','ron@example.edu'),
...
('White Apple Snow', 'Dialogue: The Chemistry of Green Energy in Iceland', 'Explore the world of finance and business opportunities in Iceland.', 2, 3, FALSE);
